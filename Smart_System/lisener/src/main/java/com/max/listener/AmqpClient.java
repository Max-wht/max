...
import com.max.config.AliIoTConfigProperties;
...
public class AmqpClient implements ApplicationRunner{
    ...
    //声明MessageListener接口 -> 需要将此接口的所有方法重写
//    private MessageListener messageListener;
    //代码块
    //在创建匿名内部类时，由于无法显式地定义构造函数，实例代码块是初始化成员变量的一种方式。
//    {
...
//    }
    ...
    //创建匿名内部类的实例，该内部类实现了MessageListener接口
    private MessageListener messageListener;
    {
    ...
    private void processMessage(Message message) {
        try {
            ...
            //将content中电量内容转换为java对象
            contentService.getData(content);
